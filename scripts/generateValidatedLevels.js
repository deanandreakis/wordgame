...
const VALID_WORDS = new Set([
  ...
  'dale', 'dame', 'dare', 'dark', 'data', 'date', 'dawn', 'days', 'dead', 'deal', 'dean', 'dear', 'debt', 'deck', 'deep', 'deer', 'deny', 'desk', 'dial', 'dice', 'diet', 'dime', 'dire', 'disc', 'dish', 'disk', 'dive', 'does', 'done', 'doom', 'door', 'dose', 'down', 'draw', 'drew', 'drop', 'drug', 'dual', 'dull', 'dumb', 'dump', 'dune', 'dusk', 'dust', 'duty',
